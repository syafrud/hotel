...
<body data-bs-spy="scroll" data-bs-offset="120" data-bs-target="#mainNav">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-3 col-5">
                    <a href="../test/index.php" class="logo_normal">
                        <img src="../img/phoenix.png" width="50" alt="" class="img-fluid" />
                    </a>
                    <a href="../test/index.php" class="logo_sticky">
                        <img src="../img/phoenix.png" width="50" alt="" class="img-fluid" />
                    </a>
                </div>
                <div class="col-md-9 col-7">
                    <div class="main-menu">
                        ...
                        <nav id="mainNav">
                            <ul>
                                <li>
                                    <a href="../test/index.php" class="js-scroll-trigger animated_link">Home</a>
                                </li>
                                <li>
    ...
    $(document).ready(function() {
        ...
        $("#Book").click(function() {
            window.location.href = '../test/index.php#first_tab';
            // Use jQuery to select and manipulate the elements
            var $secondTab = $("#second_tab");
