...
<body>
    <header class="bg-dark text-white">
        ...
        <div class="hero bg-primary text-center py-5">
            <div class="container">
                <h2 class="display-4">
                    Selamat Datang
                    <?php echo $_SESSION['username']; ?>, di Hotel XYZ
                </h2>
    ...
    <section id="beranda" class="py-5">
        <div class="container">
            ...
            <p class="text-center">
                Hotel XYZ adalah tempat yang sempurna untuk menghabiskan waktu liburan
    ...
    <section id="kontak" class="bg-light py-5">
        <div class="container">
            ...
            <p class="text-center">
                Jika Anda memiliki pertanyaan atau ingin melakukan pemesanan, jangan
                ragu untuk menghubungi kami.
            </p>
            <a href="" class="btn btn-primary btn-lg d-block mx-auto">Hubungi Kami</a>
        </div>
    </section>
